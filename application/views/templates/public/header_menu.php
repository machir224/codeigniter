...
<div class="collapse navbar-collapse order-3" id="navbarCollapse">
    <ul class="navbar-nav">
        <li class="nav-item <?= ($this->router->method === "index" || $this->router->method === "home") ? "active" : "not-active" ?>"><a class="nav-link" href="<?php echo base_url(); ?>"><?php echo ucwords(lang('home')); ?></a></li>
...
<ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-footer">
                    ...
                    if ($this->ion_auth->is_admin()) { ?>
                        <a href="<?php echo base_url('admin'); ?>" class="btn btn-default btn-flat"><?php echo ucwords(lang('dashboard')); ?></a>
                    <?php } else { ?>
                        <a href="<?= base_url('user/profile'); ?>" class="btn btn-default btn-flat"><?php echo ucwords(lang('profile')); ?></a>
                    <?php } ?>
                    <!-- <a href="#" class="btn btn-default btn-flat"><?php echo ucwords(lang('profile')); ?></a> -->
    ...
    ?>
        ...
        <li class="nav-item dropdown user-menu">
            <!-- Menu Toggle Button -->
            <a class="nav-link dropdown-toggle <?= ($this->router->method === "login") ? "active" : "not-active" ?>" href="<?php echo base_url('user') ?>">
